...
export const APIS = [GpControllerService, GpSurgeryControllerService, HealthConditionControllerService, OrganisationControllerService, PatientControllerService, UserControllerService];
