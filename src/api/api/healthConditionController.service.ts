...
export class HealthConditionControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCondition1(body: Question, conditionId: string, observe?: 'body', reportProgress?: boolean): Observable<Question>;
    public getCondition1(body: Question, conditionId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Question>>;
    public getCondition1(body: Question, conditionId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Question>>;
    public getCondition1(body: Question, conditionId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling getCondition1.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCondition2(conditionId: string, observe?: 'body', reportProgress?: boolean): Observable<HealthCondition>;
    public getCondition2(conditionId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<HealthCondition>>;
    public getCondition2(conditionId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<HealthCondition>>;
    public getCondition2(conditionId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (conditionId === null || conditionId === undefined) {
            throw new Error('Required parameter conditionId was null or undefined when calling getCondition2.');
        }
