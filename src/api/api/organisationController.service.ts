...
export class OrganisationControllerService {
    ...
    public createOrganisation(
        ...
        observe?: 'response',
        reportProgress?: boolean
    ): Observable<HttpResponse<Organisation>>;
    public createOrganisation(
        body: Organisation,
        observe?: 'events',
        reportProgress?: boolean
    ): Observable<HttpEvent<Organisation>>;
    public createOrganisation(
        body: Organisation,
        observe: any = 'body',
        ...
        if (body === null || body === undefined) {
            throw new Error(
                'Required parameter body was null or undefined when calling createOrganisation.'
            );
        }
        ...
        return this.httpClient.request<Organisation>(
            'post',
    ...
    public deleteOrganisation(
        ...
        if (organisationId === null || organisationId === undefined) {
            throw new Error(
                'Required parameter organisationId was null or undefined when calling deleteOrganisation.'
            );
        }
        ...
        return this.httpClient.request<any>(
            'delete',
            `${this.basePath}/organisation/${encodeURIComponent(String(organisationId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getOrganisation(
        ...
        if (organisationId === null || organisationId === undefined) {
            throw new Error(
                'Required parameter organisationId was null or undefined when calling getOrganisation.'
            );
        }
    ...
    public updateOrganisation(
        ...
        if (body === null || body === undefined) {
            throw new Error(
                'Required parameter body was null or undefined when calling updateOrganisation.'
            );
        }
